...
// static void UpdatePresence()
    // {
        ...
        // discordPresence.state = "Sirviendo a los señores supremos";
...
bot.on('message', (message) => {
    ...
    case `bucle`
		message.channel.sendMessage('bucle');
		break;
	...
	case `${prefix}D`{
		message.channel.send(`https://myanimelist.cdn-dena.com/images/characters/6/264411.jpg\n Me despido <@${message.author.id}>-sama`);
		bot.destroy();
		break;
	}
	...
	case `${prefix}adios`
		message.channel.send(`Ha sido un placer <@${message.author.id}>-sama`);
		break;
